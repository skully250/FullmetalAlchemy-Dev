		...
		if(world.isRemote) {
			...
			if(player.getCurrentEquippedItem() != null) {
				if(player.getCurrentEquippedItem().getItem() == FMAItems.ChalkStick && player.inventory.hasItem(FMAItems.AlchNotebook.itemID) && player.inventory.hasItem(Chalk) && First == true) {
					...
					TransmutationParticle.spawnTransmutationFX(par2, par3, par4, mx, 0, mz, 500, false, true, true, false);
					...
					for (int i = 0; i < 4; i++) {
						TransmutationParticle.spawnTransmutationFX(par2, par3, par4, mx, 0, mz, 1000, false, true, true, false);
						TransmutationParticle.spawnTransmutationFX(par2, par3, par4, -mx, 50, -mz, 1000, false, true, true, false);
						TransmutationParticle.spawnTransmutationFX(par2, par3, par4, mz, 100, mx, 1000, false, true, true, false);
						TransmutationParticle.spawnTransmutationFX(par2, par3, par4, -mz, 150, -mx, 1000, false, true, true, false);
					}
				}
				if(First == false) {
					FMAResearchRecipes.initializeAlchemy();

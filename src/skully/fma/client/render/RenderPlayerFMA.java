...
public class RenderPlayerFMA extends RenderPlayer {
	...
	protected void renderSpecials(AbstractClientPlayer player, float par2) {
		...
		this.bindTexture(new ResourceLocation(Resources.MOD_ID.toLowerCase(Locale.ENGLISH), "textures/capes/admin.png"));
		...
		for(int i = 0; i < 2; ++i) {
			...
			if (player.getCommandSenderName().contains("Optik_Chiron")) {
